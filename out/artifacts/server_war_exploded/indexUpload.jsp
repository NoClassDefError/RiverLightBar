...
<ul class="daohang">
    ...
    <li><a href="indexUpload.jsp" class="active" target="_parent" style="padding: 13px 100px;">上传文件</a></li>
    <li><a style="padding: 13px 50px;" href="console.jsp" target="_parent">灯光控制</a></li>
</ul>
<div class="section1">
    <form action="upload.action" name="upload" method="post" enctype="multipart/form-data">
